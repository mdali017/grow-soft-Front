    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
      ...
      <div className="">
        <div className="flexs justify-center">
          ...
          <div class=" w-64 h-1 bg-gray-500  mt-1"></div>
        </div>
        <div class="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8 my-6">
          <form>
            ...
            <button class="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500  hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
              Send message
            </button>
          </form>
        </div>
